  ...
  },
  {
    ...
    details: [
      ...
      },
      {
        ...
        endDate: "2024.10.25",
        description: ["창업 아이디어 발표 및 비즈니스 모델 수립"],
        achievements: ["은상 수상", "AI 기술 활용"],
        role: "AI 개발",
        skills: ["Python", "TensorFlow", "Keras"],
        teamSize: 3,
      },
      {
        title: "DGIST 코딩 오딧세이 1위",
        startDate: "2024.08.15",
        endDate: "2024.08.16",
        description: ["대구 학생들을 대상으로 한 해커톤 대회"],
        achievements: ["1위", "부모와 자식을 연결하는 서비스"],
        skills: ["React Native", "알고리즘"],
      },
      {
        title: "앱잼 28회 참가",
        startDate: "2024.12.21",
        endDate: "2024.12.22",
        description: ["모바일 앱 개발 해커톤 참가"],
        achievements: ["앱 서비스 프로토타입 개발", "팀 협업"],
        skills: ["React"],
        role: "프론트 개발",
        teamSize: 4,
      },
